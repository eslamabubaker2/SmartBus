    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo">
        <div class="page-wrapper">
            ...
            <div class="page-footer">
                <div class="page-footer-inner"> 2016 &copy;ادارة الباص الذكى
                    <a href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes" title="Purchase Metronic just for 27$ and get lifetime updates for free" target="_blank">جميع الحقوق محفوظة</a>
                </div>
