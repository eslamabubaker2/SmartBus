                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                            ...
                            <li class="nav-item start active open">
                                <a href="javascript:;" class="nav-link" style="    background: #d3b836;">
                                    <i class="icon-home"></i>
                                    <span class="title" style=" font-weight: bold;">لوحة التحكم</span>
                            ...
                            <li class="nav-item  ">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-diamond" style="    color: #ffe852;"></i>
                            ...
                            <li class="nav-item  ">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-puzzle"  style="    color: #ffe852;"></i>
                            ...
                            <li class="nav-item  ">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-settings"  style="    color: #ffe852;"></i>
                                    <span class="title">أولياء الامور</span>
                            ...
                            <li class="nav-item  ">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-bulb"  style="    color:#ffe852;"></i>
                            ...
                            <li class="nav-item  ">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-briefcase"  style="    color: #ffe852;"></i>
